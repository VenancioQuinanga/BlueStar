<?php
$rf  = ' - historico de compras';
include_once('components/navbar_admin.php');
include_once("database/dbbuies.php");
include_once("database/dbadmin.php");
include_once("database/dbdashboard.php");
...
<aside>
    <form id="dropdown">
        <input type="search" name="history_searcher" id="searcher" placeholder="Pesquise por código ou data">
...
<table>
    ...
    <tbory>
        ...
        <tr>
            <td><?=$b['id']?></td>
            <td><img src="./assets/img/users/<?=$b['client_photo']?>" width="75" height="75"></td>
            <td><?=$b['value']?></td>
            <td><?=$b['date']?></td>
            <td>   
            <a href="see_buy.php?buy_id=<?=$b['id'] ?>&&client_id=<?=$b['id_client'] ?>" class="btn-primary">
