...
<aside>
    <form id="dropdown">
        <input type="search" name="clients_searcher" id="searcher" placeholder="Pesquise pelo nome ou email ou sexo">
...
<div class="container">
    ...
    <div class="wrapper" id="wrapper">
        <h1 style='padding:.5em;'>Clientes cadastrados</h1>
    </div>
...
<thead>
    ...
    <?php foreach ($client as $c): ?>
        <tr>
            <td><img src="./assets/img/users/<?=$c['photo'] ?>" width="75" height="75" style="border-radius:100%;"></td>
            <td><?=$c['name'] ?></td>
            <td><?=$c['email'] ?></td>
            <td><?=$c['sex'] ?></td>
            <td>   
            <a href="see_client.php?user_id=<?=$c['id'] ?>" class="btn-primary">
        ...
        <td>
            <a href="database/dbdelete.php?user_id=<?=$c['id'] ?>" class="btn-danger">
