...
<div class="wrapper" id="wrapper">
        <h1 style='padding:.5em;'>Meu carrinho</h1>
</div>
    <div class="wrapper">
    <div><?=$_SESSION['buy_msg'];$_SESSION['buy_msg'] = ''?></div>
    </div>


    <form action="<?=$uri ?>cart.php" method="POST">

    </form>
    
    <div><?=$_SESSION['clean_cart'];$_SESSION['clean_cart'] = '';?></div>
