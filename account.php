...
include_once('database/dbaccount.php');
...
<div class="container">
    ...
    <div class="user_photo">
        <img src="./assets/img/users/<?=$client['photo']?>" width="350" height="350em" style="border-radius:100%;">
    </div>
    ...
    <div class="table">
        <table style="width: 100%;">
            <tbory>
                ...
                <td>    
                    <a href="edit_profile.php?user_id=<?=$_SESSION['user_id'] ?>" class="btn-warning">
